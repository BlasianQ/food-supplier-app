...
admin.initializeApp();
exports.filterByPrice = (0, https_1.onRequest)(function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var maxPrice, snapshot, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error querying Firestore:", error_1);
